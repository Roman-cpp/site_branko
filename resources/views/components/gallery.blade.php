        ...
        <div class="container inner">
            ...
            <div class="cbp-panel">
                <div id="filters-container" class="cbp-filter-container text-center">
                    ...
                    <div data-filter=".1" class="cbp-filter-item"> обеспечение </div>
                    <div data-filter=".2" class="cbp-filter-item"> продукция </div>
                </div>
                <div id="grid-container" class="cbp">
                    @foreach($images as $image)
                        <div class="cbp-item {{$image->gallery->id}}"> <a href="ajax/project1.html" class="cbp-caption cbp-singlePageInline">
